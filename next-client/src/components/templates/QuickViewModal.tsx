  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="xl">
      <div className="relative">
        ...
        <button
          onClick={onClose}
          className="absolute -top-1 right-0 z-10 p-2 hover:bg-neutral-100 rounded-lg transition-colors"
          aria-label="Close"
        >
          <X size={20} />
        </button>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="relative">
            ...
            {hasSale && (
              <span className="absolute top-3 left-3 px-2 py-1 bg-red-500 text-white text-xs font-bold rounded">
                {Math.round(
                  ((template.price - template.salePrice!) / template.price) *
                    100,
                )}
                % OFF
              </span>
          ...
          <div className="flex flex-col">
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-neutral-900 mb-2 pr-8">
                {template.title}
              </h2>
