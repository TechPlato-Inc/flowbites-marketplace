...
export const CreatorOnboardingFlow = () => {
  ...
  const [searchResults, setSearchResults] = useState<
    Array<{ displayName: string; username: string }>
  >([]);
  ...
  const fetchStatus = useCallback(async () => {
    try {
      ...
      if (ob.govIdType)
        setGovId({
          govIdType: ob.govIdType,
          govIdNumber: ob.govIdNumber || "",
        });
      if (ob.bankName)
        setBankDetails({
      ...
      if (ob.referenceCreatorUsername)
        setCreatorRef({
    ...
    try {
      ...
      setOnboardingData((prev) =>
        prev
          ? {
              ...prev,
              completedSteps: [...(prev.completedSteps || []), "personal_info"],
            }
          : prev,
      );
      setCurrentStep(1);
      ...
      setOnboardingData((prev) =>
        prev
          ? {
              ...prev,
              completedSteps: [
                ...new Set([...(prev.completedSteps || []), "government_id"]),
              ],
            }
          : prev,
      );
      ...
      setOnboardingData((prev) =>
        prev
          ? {
              ...prev,
              completedSteps: [
                ...new Set([...(prev.completedSteps || []), "bank_details"]),
              ],
            }
          : prev,
      );
  ...
  const searchCreators = async (query: string) => {
    ...
    try {
      const { data } = await api.get(
        `/creators/onboarding/search?q=${encodeURIComponent(query)}`,
      );
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-neutral-500">
          Complete all steps to verify your identity and start selling on
      ...
      {onboardingData?.status === "rejected" && (
        <div className="mb-8 p-6 bg-red-50 border border-red-200 rounded-xl">
          ...
          <p className="text-red-700 text-sm">
            {(onboardingData.onboarding?.rejectionReason as string) ||
              "Your application was rejected. Please update the required information and resubmit."}
          </p>
        </div>
      )}
        ...
        <div className="bg-white border border-neutral-200 rounded-xl p-6 md:p-8">
          ...
          {currentStep === 0 && (
            <div>
              ...
              <p className="text-sm text-neutral-500 mb-6">
                Tell us about yourself. This information is used for identity
                verification.
              </p>
          ...
          {currentStep === 1 && (
            <div>
              ...
              <p className="text-sm text-neutral-500 mb-6">
                Upload a valid government-issued photo ID for identity
                verification.
              </p>
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setGovId((p) => ({ ...p, govIdType: e.target.value }))
                  }
              ...
              <div className="mb-4">
                <Input
                  ...
                  onChange={(e) =>
                    setGovId((p) => ({ ...p, govIdNumber: e.target.value }))
                  }
          ...
          {currentStep === 2 && (
            <div>
              ...
              <p className="text-sm text-neutral-500 mb-6">
                Take a clear selfie of yourself holding your government ID next
                to your face. Both your face and the ID should be clearly
                visible.
              </p>
          ...
          {currentStep === 3 && (
            <div>
              ...
              <p className="text-sm text-neutral-500 mb-6">
                Provide your bank account details for receiving payouts. All
              ...
              <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-700">
                  <strong>Security:</strong> Your bank details are encrypted at
                  rest and only used for processing payouts. We never share your
          ...
          {currentStep === 4 && (
            <div>
              ...
              <p className="text-sm text-neutral-500 mb-6">
                Provide a reference from an existing creator on Flowbites
                Marketplace. This helps us verify that you are a legitimate
                creator. The referenced creator should be someone who can vouch
                for your work.
              </p>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setCreatorRef((p) => ({
                        ...p,
                        referenceCreatorUsername: e.target.value,
                      }));
                    ...
                    {searchResults.map((creator) => (
                      <button
                        ...
                        onClick={() => {
                          setCreatorRef((p) => ({
                            ...p,
                            referenceCreatorUsername: creator.username,
                          }));
                          setSearchResults([]);
                        }}
              ...
              <div className="mt-4 p-4 bg-neutral-50 border border-neutral-200 rounded-lg">
                <p className="text-sm text-neutral-600">
                  <strong>Why do we need a reference?</strong> References from
                  established creators help us maintain marketplace quality and
                  trust. The referenced creator may be contacted to verify your
                  identity.
                </p>
              </div>
            </div>
      ...
      <label className="flex flex-col items-center justify-center h-40 border-2 border-dashed border-neutral-300 rounded-lg cursor-pointer hover:border-primary-400 hover:bg-primary-50/30 transition-all">
        {file ? (
          <div className="text-center px-4">
            ...
            <p className="text-sm text-neutral-700 font-medium truncate max-w-[200px]">
              {file.name}
            </p>
